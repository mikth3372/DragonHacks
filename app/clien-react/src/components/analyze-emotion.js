    ...
    <div className="App bg-main-color">
      ...
      <main>
        ...
        <div className="flex place-content-center pb-16 bg-main-color">
          <form onSubmit={handleJoinMeeting} className="flex flex-row">
            ...
            <button
              ...
              className="ml-10 bg-indigo-600 hover:bg-indigo-800 text-white font-bold py-2 px-4 rounded-full"
            >
              Join Meeting
            </button>
          </form>
        ...
        <div className="flex flex-row">
          <div className="flex flex-col w-3/5 ml-6 content-between">
            <div className="flex flex-col bg-slate-200 m-5 w-auto h-128">
              {/* <div className={`flex rounded ${bgColorClass} justify-center`}>
              User Status: {userStatus}
            </div> */}
              <div className="flex w-auto place-content-center justify-center items-center">
                {/* <div className="italic text-center mt-60">
                  Zoom video will pop up here
                </div> */}
            ...
            <div className="flex justify-center my-10">
              <button
                className="w-auto ml-10 bg-indigo-600 hover:bg-indigo-800 text-white font-bold mt-30 py-2 px-4 rounded-full"
